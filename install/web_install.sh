...
case "$ID" in
  centos*)
      ...
      VERSION=$VERSION_ID;
      INSTALLER_DEPS=( perl );
      BUILD_DEPS=( openssl-devel zlib-devel perl-Safe perl-Dumpvalue perl-Digest-SHA perl-Test-Simple perl-Sys-Hostname perl-English perl-Hash-Util-FieldHash );
  ...
  fedora*)
      ...
      VERSION=$VERSION_ID;
      INSTALLER_DEPS=( perl );
      BUILD_DEPS=( openssl-devel zlib-ng-compat-devel perl-Safe perl-Dumpvalue perl-Digest-SHA perl-Test-More-UTF8 perl-Sys-Hostname perl-English perl-Hash-Util-FieldHash );
      BUILD_GROUP_DEPS=('development-tools' ); 
      RUN_DEPS=();
      ;; 
  *)
